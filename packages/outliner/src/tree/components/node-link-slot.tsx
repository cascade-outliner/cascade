...
export function DefaultNodeLink({ icon }: { icon?: string | null }) {
	return (
		...
		>
			...
			<span className="absolute inset-0 m-auto h-3.5 w-3.5 rounded-full bg-ink opacity-0 blur-sm transition-opacity group-hover/node-link:opacity-40 dark:bg-surface" />
