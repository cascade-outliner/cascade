...
## 2026-08-05
- [fix] Clicking the header logo to return to the root tree now plays the same cross-fade view transition every other node/tree navigation link already uses, instead of a hard cut. [#635](https://github.com/cascade-outliner/cascade/issues/635)
