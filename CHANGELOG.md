...
## 2026-07-18
- Added a persistent header (brand, search, tree switcher, and an overflow menu for sharing/theme/font/report-an-issue) above the outliner, replacing the floating user-menu avatar. The dark/light toggle is live; the rest are placeholders for upcoming features. [#261](https://github.com/Patrickroelofs/cascade/issues/261)
