...
## 2026-08-07
- [feat] A node's breadcrumb trail now lives in the app header next to the logo instead of above the node's title, so it stays put while the page below it scrolls. [#666](https://github.com/cascade-outliner/cascade/issues/666)
