...
## 2026-08-05
- [perf] Clicking a node's focus dot on a large tree no longer briefly freezes/blanks the screen before the detail page appears — deriving a view's rows no longer re-sorts every sibling group across the user's entire tree, only the ones in the subtree actually being viewed. [#633](https://github.com/cascade-outliner/cascade/issues/633)
