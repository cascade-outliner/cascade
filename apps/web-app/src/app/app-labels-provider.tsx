...
function createOutlinerLabels(): OutlinerLabels {
	return {
		...
		colorLabels: {
			...
			yellow: m.outliner_color_yellow(),
			green: m.outliner_color_green(),
			blue: m.outliner_color_blue(),
			purple: m.outliner_color_purple(),
			pink: m.outliner_color_pink(),
			gray: m.outliner_color_gray(),
		},
