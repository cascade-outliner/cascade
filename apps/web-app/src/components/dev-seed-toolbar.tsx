...
const styles = stylex.create({
	toolbar: {
		position: "fixed",
		bottom: { default: space["16"], "@media (max-width: 640px)": space["8"] },
		left: { default: space["16"], "@media (max-width: 640px)": space["8"] },
	...
	button: {
		...
		alignItems: "center",
		gap: space["7"],
		paddingBlock: { default: space["8"], "@media (hover: none)": space["11"] },
		paddingInline: {
			default: space["11"],
			"@media (max-width: 640px)": space["9"],
		},
