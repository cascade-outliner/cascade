	...
	return (
		<section id="features" className="mx-auto max-w-6xl px-8 pt-8 pb-48">
			<div className="flex flex-col items-center pb-4">
				<WavesIcon className="fill-danger" size={64} weight="thin" />
			</div>
				...
				>
					<div className="flex h-12 flex-col justify-center gap-2">
						<div className="flex items-center gap-2">
							...
							<span className="h-0.75 w-18 rounded-sm bg-surface" />
						</div>
						<div className="flex items-center gap-2 pl-4.5">
							<span className="size-1.5 rounded-full bg-muted" />
							<span className="h-0.75 w-14 rounded-sm bg-surface" />
						</div>
						<div className="flex items-center gap-2 pl-9">
							<span className="size-1.5 rounded-full bg-accent" />
							<span className="h-0.75 w-10 rounded-sm bg-surface" />
						</div>
					</div>
				</FeatureCard>
				<FeatureCard
